...
def main():
    ...
    my_command = my_command.replace('--DBRelease="default:current"', '') # avoid CVMFS reading 
    ...
    if not os.path.exists("./poolcond"):
        os.mkdir("./poolcond")
    prep_comm="cp /lustre/atlas/proj-shared/csc108/app_dir/atlas_app/atlas_rel/19.2.4/DBRelease/current/poolcond/*.xml  ./poolcond/."
    ...
    true_sql_dir = "/lustre/atlas/proj-shared/csc108/ATLAS_db/19.2.4/DBRelease/current/sqlite200"
